  ...
  if (args !== undefined) {
    if (command === 'SET_DENOMINATION_ROUTE') {
      if (protocolVersion >= 6) {
        return [args.route === 'payout' ? 00 : 01].concat([...int32LE(args.value)], [...Buffer.from(args.country_code, 'ascii')])
      }
      return [args.route === 'payout' ? 00 : 01].concat([...(args.isHopper ? int16LE(args.value) : int32LE(args.value))])
